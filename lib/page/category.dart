import 'package:dd_blog_flutter/components/post_list.dart';
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Container(
          ...
          child: ListTile(
            ...
            onTap: () => PostListComponents.navWithCategory(context, '${item.id}', title: item.name),
          ),
        );
      },
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Container(
          ...
          child: ListTile(
            ...
            onTap: () => PostListComponents.navWithMonth(context, item.months, title: item.months),
          ),
        );
      },
      itemCount: list.length,
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Container(
          ...
          child: ListTile(
            ...
            onTap: () => PostListComponents.navWithTag(context, '${item.id}', title: item.name),
          ),
        );
      },
      itemCount: list.length,
